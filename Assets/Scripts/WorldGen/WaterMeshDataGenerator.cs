...
class WaterMeshDataGenerator : MeshDataGenerator {
    ...
    public static MeshData[] GenerateWaterMeshData(BlockDataMap pointmap, float voxelSize = 1f, Vector3 offset = default(Vector3), MeshDataType meshDataType = MeshDataType.TERRAIN) {
