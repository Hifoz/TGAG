...
class NaiveMeshGenerator {
    ...
    public NaiveMeshGenerator(BlockDataMap blockDataMap, float voxelSize = 1f, Vector3 offset = default(Vector3),
                              MeshDataGenerator.MeshDataType meshDataType = MeshDataGenerator.MeshDataType.TERRAIN,
                              Vector2 animalData = default(Vector2)) {
